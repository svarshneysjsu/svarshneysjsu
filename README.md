...
<!-- As a AI enthusiast with a robust background in analytics and machine learning, I specialize in transforming complex datasets into actionable insights. My expertise spans across building scalable data pipelines, integrating AI models into robotics, and developing NLP solutions. -->
...
My work bridges the gap between cutting-edge research and scalable systems—whether it's building decision-making bots, fine-tuning transformer models, or enabling intelligent data pipelines on AWS and GCP.
...
- **Cloud Platforms:** AWS (S3, Lambda, Glue, EC2)
- **Orchestration Tools:** Apache Airflow
- **Visualization:** Matplotlib, Seaborn, Tableau, AWS QuickSight -->
...
**GitHub Repository:**  
[https://github.com/svarshneysjsu/Paraphrase-Detection](https://github.com/svarshneysjsu/Paraphrase-Detection)
...
<!--
**svarshneysjsu/svarshneysjsu** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
